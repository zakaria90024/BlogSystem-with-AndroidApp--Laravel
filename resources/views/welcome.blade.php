...
<head>
  ...
  <title>Blog-System with Android Apps</title>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="index.html">Blog-Zakaria</a>
      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="site-heading">
            <h1>Blog-System </h1>
            <span class="subheading">with Android Apps</span>
            <span class="subheading">Tools: Laravel, RestApi, Postman, Android Studio-java </span>
          </div>
        </div>
      </div>
    </div>
  ...
  <script src="{{asset('public/frontend/vendor/js/clean-blog.min.js')}}"></script>
